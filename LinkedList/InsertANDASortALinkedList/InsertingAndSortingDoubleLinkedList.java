...
class Result {
    ...
    public static DoublyLinkedListNode sortedInsert(DoublyLinkedListNode head, int data) {
        ...
        if(head == null){
            ...
            newNode = sortedInsert(current.next, newNode.data); //Sort the linked list
            //  and insert Insert the new node, we need to passt the next node and the data
            //We will stop in the last node, like the newNode next, set the function
            //we only set the next of the previous node and also the previous of the next node
